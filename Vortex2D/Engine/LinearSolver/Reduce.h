...
public:
   ...
   * @param size
   */
  VORTEX2D_API ReduceSum(Renderer::Device& device, const glm::ivec2& size);
};
...
public:
   ...
   * @param size
   */
  VORTEX2D_API ReduceJ(Renderer::Device& device, const glm::ivec2& size);
};
...
public:
   ...
   * @param size
   */
  VORTEX2D_API ReduceMax(Renderer::Device& device, const glm::ivec2& size);
};
